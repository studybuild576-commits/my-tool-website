...
export const metadata: Metadata = {
  ...
  keywords: [
    "case converter","uppercase converter","lowercase converter","capitalize text","title case",
    "sentence case","online case converter","free text tools","in-browser case conversion",
    "no signup case converter","private text converter","toggle case","camel case","kebab case",
    "snake case","pascal case","copy text online","text utilities","word counter","character counter"
  ],
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-10">
      ...
      <div className="relative overflow-hidden rounded-2xl mb-6">
        ...
        <svg className="absolute inset-0 w-full h-full" viewBox="0 0 800 400" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Convert text case online">
          <defs>
          ...
          <path d="M110,250 C170,180 300,170 380,210 C450,245 520,260 600,230 C650,210 690,170 670,130 C640,80 560,80 500,110 C430,145 360,160 280,150 C210,140 160,160 130,190 C110,210 100,230 110,250 Z" fill="url(#fill-case)" stroke="url(#stroke-case)" strokeWidth="2" />
        </svg>
        <div className="relative p-8 sm:p-10">
          <h1 className="text-3xl font-extrabold text-indigo-900">🔠 Case Converter — Free & Private</h1>
          <p className="mt-2 text-sm sm:text-base text-slate-700">Convert text to UPPERCASE, lowercase, Capitalized, Title Case, and more—no signup, in‑browser.</p>
        </div>
      </div>
      ...
      <section className="mt-8">
        ...
        <details className="mb-2"><summary>Data upload hota hai?</summary><p className="text-gray-600">Nahi, sab kuchh aapke browser me process hota hai.</p></details>
